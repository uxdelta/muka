...
export const Button: React.FC<ButtonProps> = ({
  ...
  const getButtonStyles = (): React.CSSProperties => {
    const baseStyles: React.CSSProperties = {
      ...
      fontFamily: 'var(--button-typography-md-fontFamily, var(--alias-font-brand-family, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif))',
      fontWeight: 'var(--button-typography-md-fontWeight, var(--alias-font-brand-weight-semibold, 600))',
      textDecoration: 'none',
      border: 'none',
    ...
    const sizeStyles: Record<string, React.CSSProperties> = {
      sm: {
        ...
        fontSize: 'var(--button-typography-sm-fontSize, 0.875rem)',
        lineHeight: 'var(--button-typography-sm-lineHeight, 1.25rem)',
        minHeight: '32px',
      },
      md: {
        padding: 'var(--button-padding-md-y, 0.75rem) var(--button-padding-md-x, 0.75rem)',
        borderRadius: 'var(--button-radius-md, 6px)',
        fontSize: 'var(--button-typography-md-fontSize, 1rem)',
        lineHeight: 'var(--button-typography-md-lineHeight, 1.5rem)',
        minHeight: '40px',
      },
      lg: {
        padding: 'var(--button-padding-lg-y, 1rem) var(--button-padding-lg-x, 1rem)',
        borderRadius: 'var(--button-radius-lg, 6px)',
        fontSize: 'var(--button-typography-lg-fontSize, 1.125rem)',
        lineHeight: 'var(--button-typography-lg-lineHeight, 1.75rem)',
        minHeight: '48px',
      },
    };
